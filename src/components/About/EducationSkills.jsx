...
const EducationSkills = () => {
  ...
  const education = [
    ...
    },
    {
      ...
      description:
        "Focused on mastering modern fullstack development with TypeScript, Tailwind CSS, Next.js, and Supabase. Building scalable, type-safe applications with strong frontend and backend integration, leveraging Supabase for authentication, database, and APIs.",
    },
    {
      period: "2022 - 2024",
    ...
    },
    {
      ...
      status: "Completed",
      description:
        "Gained foundational and practical skills in using Microsoft Office Suite (Word, Excel, PowerPoint, Access) and internet applications. Developed problem-solving abilities through IT-related tasks and built a strong understanding of computer systems, productivity tools, and basic networking concepts.",
    },
  ];
  ...
  return (
    <section id="education" className="text-white py-20 px-3 md:px-12 lg:px-24">
      <div className="container p-0 mx-auto w-full md:max-w-[96%]">
        ...
        <div
          ref={ref}
          className="grid lg:grid-cols-2 gap-12 items-start transition-opacity duration-700 ease-in-out"
        >
          {/* Skills Section */}
